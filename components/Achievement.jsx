...
import jsImg from '../public/assets/certificates/js.jpg';
    ...
    <div id="projects" className="w-full mt-10  ">
      <div className="max-w-[1240px] mx-auto px-2 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <ProjectItem title="Belajar Dasar Pemrograman Javascript" backgroundImg={jsImg} projectUrl="https://www.dicoding.com/certificates/07Z6G3WNMXQR" desc="Learn fundamental programming with Javascript" />
          <ProjectItem title="Semi-Finalist Hackathon in BCA 2021" backgroundImg={bcaImg} projectUrl="/" desc="Create website using Spring Boot & Chosen as one of the semi-finalists who received an offer to work at BCA" />
