...
import ContactImg from '../public/assets/foto-farrel-about.png';
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4">
            <div className="lg:p-4 h-full ">
              ...
              <div>
                <h2 className="py-2">Farrel Aditya</h2>
                <p>Information Systems ITS 2020</p>
          ...
          <div className="col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4">
            <div className="p-4">
              <form action="https://getform.io/f/a8cbef9c-b385-4394-9f2e-475b5a73e23d" method="POST" encType="multipart/form-data">
