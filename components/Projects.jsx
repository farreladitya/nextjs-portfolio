...
import pmImg from '../public/assets/projects/porto_pm.png';
    ...
    <div id="projects" className="w-full mt-10  ">
      <div className="max-w-[1240px] mx-auto px-2 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <ProjectItem title="Compliance Website Project Management" backgroundImg={pmImg} projectUrl="https://drive.google.com/file/d/18KQHPQHRfjya0ZSPomFgGvJ4zhOwVTyt/view?usp=sharing" tech="Ms. Excel" desc="Perform Waterfall SDLC for Compliance System Development in Toyota" />
